    ...
    <footer className="bg-gradient-to-r from-green-600 via-green-500 to-emerald-600 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a href="mailto:dicorcarbones@gmail.com" className="bg-white/20 hover:bg-white/30 p-2 rounded-full transition-all duration-200 hover:scale-110" aria-label="Enviar email">
                <Mail size={20} />
              </a>
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-white/20 text-center text-sm">
          <p className="text-white/90">© {new Date().getFullYear()} DICOR. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
