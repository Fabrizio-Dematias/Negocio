...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Si el honeypot está relleno, es un bot — rechazar silenciosamente
    ...
    try {
      ...
      if (!response.ok) {
        // El backend puede devolver mensajes de rate limiting
        toast.error(data.message || "Hubo un error al enviar el mensaje")
        return
      }
